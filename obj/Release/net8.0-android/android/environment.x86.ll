...
@dso_cache = dso_local local_unnamed_addr global [796 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 194713860, ; hash 0xb9b1904, from name: aot-BisleriumCafe
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 411288013, ; hash 0x1883c1cd, from name: libaot-Syncfusion.Pdf.Portable.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 486494976, ; hash 0x1cff5300, from name: libaot-Syncfusion.Compression.Portable.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 994236471, ; hash 0x3b42d837, from name: libaot-Syncfusion.Compression.Portable
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.35_name, ; name: libaot-Syncfusion.Compression.Portable.dll.so
		ptr null; void* handle (0x0)
	}, ; 169
	...
	%struct.DSOCacheEntry {
		i64 1129373361, ; hash 0x4350deb1, from name: libaot-BisleriumCafe.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BisleriumCafe.dll.so
		ptr null; void* handle (0x0)
	}, ; 189
	...
	%struct.DSOCacheEntry {
		i64 1196137959, ; hash 0x474b9de7, from name: aot-BisleriumCafe.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BisleriumCafe.dll.so
		ptr null; void* handle (0x0)
	}, ; 202
	...
	%struct.DSOCacheEntry {
		i64 1264538220, ; hash 0x4b5f526c, from name: Syncfusion.Compression.Portable
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.35_name, ; name: libaot-Syncfusion.Compression.Portable.dll.so
		ptr null; void* handle (0x0)
	}, ; 219
	...
	%struct.DSOCacheEntry {
		i64 1514382048, ; hash 0x5a43a2e0, from name: aot-iTextSharp.LGPLv2.Core
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1784405195, ; hash 0x6a5bdccb, from name: aot-Syncfusion.Pdf.Portable.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.37_name, ; name: libaot-Syncfusion.Pdf.Portable.dll.so
		ptr null; void* handle (0x0)
	}, ; 312
	...
	%struct.DSOCacheEntry {
		i64 1986216266, ; hash 0x7663414a, from name: libaot-iTextSharp.LGPLv2.Core.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-iTextSharp.LGPLv2.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 353
	...
	%struct.DSOCacheEntry {
		i64 2099315164, ; hash 0x7d2101dc, from name: Syncfusion.Pdf.Portable.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.37_name, ; name: libaot-Syncfusion.Pdf.Portable.dll.so
		ptr null; void* handle (0x0)
	}, ; 373
	...
	%struct.DSOCacheEntry {
		i64 2177084997, ; hash 0x81c3ae45, from name: libaot-BisleriumCafe
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BisleriumCafe.dll.so
		ptr null; void* handle (0x0)
	}, ; 393
	...
	%struct.DSOCacheEntry {
		i64 2507081867, ; hash 0x956f088b, from name: aot-Syncfusion.Compression.Portable
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.35_name, ; name: libaot-Syncfusion.Compression.Portable.dll.so
		ptr null; void* handle (0x0)
	}, ; 460
	...
	%struct.DSOCacheEntry {
		i64 2640713052, ; hash 0x9d66155c, from name: libaot-Syncfusion.Pdf.Portable
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.37_name, ; name: libaot-Syncfusion.Pdf.Portable.dll.so
		ptr null; void* handle (0x0)
	}, ; 491
	...
	%struct.DSOCacheEntry {
		i64 2823258941, ; hash 0xa847833d, from name: aot-Syncfusion.Pdf.Portable
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.37_name, ; name: libaot-Syncfusion.Pdf.Portable.dll.so
		ptr null; void* handle (0x0)
	}, ; 528
	...
	%struct.DSOCacheEntry {
		i64 2993609853, ; hash 0xb26edc7d, from name: Syncfusion.Compression.Portable.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.35_name, ; name: libaot-Syncfusion.Compression.Portable.dll.so
		ptr null; void* handle (0x0)
	}, ; 560
	...
	%struct.DSOCacheEntry {
		i64 3020527151, ; hash 0xb409962f, from name: iTextSharp.LGPLv2.Core
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-iTextSharp.LGPLv2.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 564
	...
	%struct.DSOCacheEntry {
		i64 3031627522, ; hash 0xb4b2f702, from name: aot-Syncfusion.Compression.Portable.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.35_name, ; name: libaot-Syncfusion.Compression.Portable.dll.so
		ptr null; void* handle (0x0)
	}, ; 568
	...
	%struct.DSOCacheEntry {
		i64 3735265744, ; hash 0xdea3a1d0, from name: BisleriumCafe.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BisleriumCafe.dll.so
		ptr null; void* handle (0x0)
	}, ; 703
	%struct.DSOCacheEntry {
		i64 3735949388, ; hash 0xdeae104c, from name: libaot-iTextSharp.LGPLv2.Core
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-iTextSharp.LGPLv2.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 704
	...
	%struct.DSOCacheEntry {
		i64 3887849470, ; hash 0xe7bbdffe, from name: BisleriumCafe
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BisleriumCafe.dll.so
		ptr null; void* handle (0x0)
	}, ; 720
	...
	%struct.DSOCacheEntry {
		i64 4219826754, ; hash 0xfb857242, from name: aot-iTextSharp.LGPLv2.Core.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-iTextSharp.LGPLv2.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 778
	%struct.DSOCacheEntry {
		i64 4221941870, ; hash 0xfba5b86e, from name: Syncfusion.Pdf.Portable
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.37_name, ; name: libaot-Syncfusion.Pdf.Portable.dll.so
		ptr null; void* handle (0x0)
	}, ; 779
	...
	%struct.DSOCacheEntry {
		i64 4280550888, ; hash 0xff2405e8, from name: iTextSharp.LGPLv2.Core.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-iTextSharp.LGPLv2.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 790
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [162 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
